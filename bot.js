...
client.on('message', message => {
    ...
    .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=515836471782014988bot`)  // حط اي دي بوتك
...
if (!profile[getvalueof.id]) profile[getvalueof.id] = {points: 0,reps: "NOT YET",credits: 1, level: 1,tite: "HypeLC User", rep: 0, lastDaily: "NOT COLLECTED"};
            ...
            fs.readFile("images.png", function (err, Background) { //امتداد الصورة
...
client.login("NTE1NTE0OTMxMzcwNzg2ODE3.DtnYZw.E0DcoEQYn92Gl5Y8rzQ407SyrqE");  // توكن حقق